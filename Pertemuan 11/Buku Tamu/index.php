...
<body>
	...
	<div class="panel-heading">
		<center><h3 class="panel-title">Form Input Buku Tamu</h3></center>
	</div>
...
<?php
	...
	<table class="table" cellpadding="0" cellspacing="1" bgcolor="#B2E9FB">
            <tr>
                <td align="center" valign="middle" bgcolor="#F6FCFF"><strong>Terimakasih!!</strong> Anda telah mengisi Buku Tamu </td>
            </tr>
            <tr>
			...
			<tr>
				<td height="47" align="center">
					<table width="431" border="0" cellpadding="2" cellspacing="0">
						<tr>
							<td><b style="color:#"><?=$gede=strtoupper($bukutm['nama'])?></b><br>
