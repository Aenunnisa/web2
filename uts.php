            ...
            <tr> 
                ...
                <tr>
                        ...
                        <tr>
                            ...
                            <td> : </td>
                            <td><input type="text" name="positif" size="45"></td>
                        </tr>
                        <tr>
                            <td>Jumlah Dirawat</td>
                            <td> : </td>
                            <td><input type="text" name="rawat" size="45"></td>
                        </tr>
                        <tr>
                            <td>Jumlah Sembuh</td>
                            <td> : </td>
                            <td><input type="text" name="sembuh" size="45"></td>
                        </tr>
                        <tr>
                            <td>Jumlah Meninggal</td>
                            <td> : </td>
                            <td><input type="text" name="meninggal" size="45"></td>
                        </tr>
                        <tr>
                            <td>Nama Operator</td>
                            <td> : </td>
